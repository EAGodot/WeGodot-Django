...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('web_name', models.CharField(default='我的技术博客', max_length=16, verbose_name='网站名称')),
                ('web_title', models.CharField(default='欢迎来到我的技术博客', max_length=512, verbose_name='网站信息')),
                ('notices', models.CharField(blank=True, default='🎉 欢迎访问！网站正在建设中...', max_length=512, null=True, verbose_name='公告')),
                ('footer', models.CharField(default='© 2024 我的博客 · Powered by Django', max_length=256, verbose_name='页脚')),
                ('background_image', models.CharField(blank=True, default='/static/images/default-bg.jpg', max_length=256, null=True, verbose_name='背景')),
                ('avatar', models.CharField(default='/static/images/default-avatar.png', max_length=256, verbose_name='头像')),
                ('random_avatar', models.TextField(blank=True, default='/static/images/avatar1.jpg,/static/images/avatar2.jpg,/static/images/avatar3.jpg', null=True, verbose_name='随机头像')),
                ('random_name', models.CharField(blank=True, default='访客,用户,小伙伴,朋友', max_length=4096, null=True, verbose_name='随机名称')),
                ('random_cover', models.TextField(blank=True, default='/static/images/cover1.jpg,/static/images/cover2.jpg', null=True, verbose_name='随机封面')),
                ('waifu_json', models.TextField(blank=True, default='{"welcome": "欢迎来到我的博客！", "messages": ["你好呀！", "今天过得怎么样？", "有什么需要帮助的吗？"]}', null=True, verbose_name='看板娘消息')),
                ('status', models.BooleanField(default=True, verbose_name='是否启用[0:否，1:是]')),
            ],
            options={
                'verbose_name': '网站信息表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('article_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appone.article', verbose_name='文章ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.SmallIntegerField(choices=[(0, 'Boss'), (1, '管理员'), (2, '普通用户'), (3, '访客')], default=2, verbose_name='用户类型')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='最终修改时间')),
                ('update_by', models.CharField(blank=True, max_length=32, null=True, verbose_name='最终修改人')),
                ('deleted', models.BooleanField(default=False, verbose_name='是否删除')),
                ('province', models.CharField(blank=True, max_length=20, null=True, verbose_name='省')),
                ('qiniu_domain', models.CharField(blank=True, max_length=128, null=True, verbose_name='七牛云域名')),
                ('qiniu_bucket_name', models.CharField(blank=True, max_length=128, null=True, verbose_name='七牛云bucket')),
                ('qiniu_secret_key', models.CharField(blank=True, max_length=128, null=True, verbose_name='七牛云secret_key')),
                ('qiniu_access_key', models.CharField(blank=True, max_length=128, null=True, verbose_name='七牛云access_key')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'comment',
                'indexes': [models.Index(fields=['source'], name='idx_comment_source')],
            },
        ),
        migrations.CreateModel(
            name='Family',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to=appone.models.image.user_image_upload_path)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'wei_yan',
                'indexes': [models.Index(fields=['user_id'], name='wei_yan_user_id_32c565_idx')],
            },
        ),
    ]
